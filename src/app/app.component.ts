...
import {AnsynApi} from 'ng-ansyn/src/appBuilder/ansyn-api.service'
@Component({
  selector: 'app-root',
...
export class AppComponent {
  title = 'app works!';
  mapLayout: boolean = true;
  windowLayout : boolean = true;

  constructor(public ansynapi : AnsynApi) {
  ...
  changeLayout() {
    this.mapLayout = !this.mapLayout;
    this.ansynapi.changeMapLayout(this.mapLayout? 'layout4' : 'layout2')
  }


  changeWindowsLayout() {
    this.windowLayout = !this.windowLayout;
    const firstLayout = {
      "menu": false,
      "statusBar": false,
      "timeLine": true,
    ...
    this.ansynapi.changeWindowLayout(this.windowLayout? firstLayout : secondLayout)

  }

  setLayouts() {
    this.ansynapi.setOverlayes([
        {
